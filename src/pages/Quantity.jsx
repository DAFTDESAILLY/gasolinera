...
export default function Quantity() {
  ...
  return (
    <>
      <Grid marginBottom={5}>
        <Heading size="lg"> cantidad de litros </Heading>
      ...
      <Box marginTop="40px">
        <Stack direction="row" spacing={4} cursor="pointer" display="flex" justifyContent="space-between">
          <Button leftIcon={<ArrowBackIcon />} colorScheme="teal" variant="outline" size="lg" onClick={() => navigate("/Method-Payment")}>
            Volver atras
          </Button>
          <Button rightIcon={<ArrowForwardIcon />} colorScheme="teal" variant="solid" size="lg" onClick={() => navigate("/resume")}>
            Continuar
          </Button>
        </Stack>
      </Box>
